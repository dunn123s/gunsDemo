...
public class GoogleAuthenticator {
    ...
    public static final String SEED                    = "f8GjEvTbW5oVSV7avLBdwIHqGlUYNzKFI7izOF8GwLDVKs2m0QN7vxRs2im5MDaNCWGmcD2rvcZx";

    public static final String RANDOM_NUMBER_ALGORITHM = "SHA1PRNG";

    static int                        window_size             = 2;// default 3 - max 17 (from google docs)最多可偏移的时间

    
    public static void main(String[] args) {
//      boolean e =check_code("HJMEJDIK2R27P4QB", Long.parseLong("254111"), System.currentTimeMillis());
