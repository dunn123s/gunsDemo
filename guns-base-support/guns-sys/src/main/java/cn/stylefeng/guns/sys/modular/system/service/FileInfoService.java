...
public class FileInfoService extends ServiceImpl<FileInfoMapper, FileInfo> {
     ...
     * @Date 2019-05-04 17:18
     */
    public String uploadFile(MultipartFile file, String fileCatg) {
     ...
     * @Date 2019-05-04 17:18
     */
    public String uploadFileInfo(String fileName, String fileCatg) {
        ...
        String finalName = fileId + "." + ToolUtil.getFileSuffix(fileName);
        try {
            //保存文件信息
            FileInfo fileInfo = new FileInfo();
            fileInfo.setFileId(fileId);
