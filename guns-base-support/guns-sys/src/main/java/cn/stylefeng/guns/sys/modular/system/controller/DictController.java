...
public class DictController extends BaseController {
    ...
    public LayuiPageInfo select(@RequestParam("dictTypeCode") String dictTypeCode) {
        List<Dict> dicts = this.dictService.listDictsByCode(dictTypeCode);
        LayuiPageInfo page = new LayuiPageInfo();
        page.setCode(0);
        page.setCount(dicts.size());
        page.setData(dicts);
        return page;
    }
